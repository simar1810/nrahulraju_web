    ...
    <section className="bg-[#FAFAFA] min-h-screen py-12 px-6 sm:px-10 lg:px-20 xl:px-32 overflow-hidden">
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-2xl p-6 sm:p-10 lg:p-12 border border-gray-100">
        ...
        <div className="space-y-6 text-[#494848] leading-relaxed text-sm sm:text-base">
          ...
          <p>Welcome to NRahulRaju!</p> 

          <p>
            These terms and conditions outline the rules and regulations for the use
            of NRahulRaju&apos;s website, located at {" "}
            <a
              href="https://www.nrahulraju.com"
              target="_blank"
          ...
          <p>
            ...
            conditions. Do not continue to use NRahulRaju if you do not agree to
          ...
          <p>
            ...
            &quot;We&quot;, &quot;Our&quot;, and &quot;Us&quot; refer to NRahulRaju
          ...
          <p>
            We employ the use of cookies. By accessing NRahulRaju, you agree to
            use cookies in accordance with NRahulRaju&apos;s Privacy Policy.
          </p>
          ...
          <p>
            Unless otherwise stated, NRahulRaju and/or its licensors own the
            intellectual property rights for all material on NRahulRaju. All
            intellectual property rights are reserved. You may access this from
            NRahulRaju for your own personal use subject to the restrictions set
            in these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc list-inside space-y-1">
            <li>Republish material from NRahulRaju;</li>
            <li>Sell, rent, or sub-license material from NRahulRaju;</li>
            <li>Reproduce, duplicate, or copy material from NRahulRaju;</li>
            <li>Redistribute content from NRahulRaju.</li>
          </ul>
          ...
          <p>
            ...
            exchange opinions and information in certain areas of the website. NRahulRaju does not filter, edit, publish, or review Comments prior to their
            presence on the website. Comments do not reflect the views or opinions
            of NRahulRaju, its agents, and/or affiliates. Comments reflect the
            views and opinions of the person who posts them. To the extent permitted
            by applicable law, NRahulRaju shall not be liable for the Comments or
          ...
          <p>
            NRahulRaju reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant NRahulRaju a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            the hyperlink compensates the absence of NRahulRaju; and (d) the link
          ...
          <p>
            No use of NRahulRaju&apos;s logo or other artwork will be allowed for
